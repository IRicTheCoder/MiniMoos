...
public class EntityFrankCattlello extends EntityMiniMoo
{
	public EntityFrankCattlello(World worldIn)
	{
		super(worldIn);
	}
	...
	{
		return new ItemStack(Blocks.LAPIS_ORE, 1).getItem();
	}
	...
	private void affectPlayer(EntityPlayer player)
	{
		...
		{
			case 0:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.costello.street", playerName)));
				player.addPotionEffect(new PotionEffect(MobEffects.INSTANT_DAMAGE, 2, 1, true, true));
				break;
			case 1:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.costello.war", playerName)));
				player.addPotionEffect(new PotionEffect(MobEffects.LEVITATION, 120, 0, true, true));
				break;
			case 2:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.costello.cigar", playerName)));
				player.setFire(14);
				break;
		}
	}
	...
	{
		return LootManager.FRANK_CATTLELLO;
	}
	...
	{
		return new ResourceLocation(References.MODID, "textures/entity/bosses/frankCattlello.png");
	}
}
