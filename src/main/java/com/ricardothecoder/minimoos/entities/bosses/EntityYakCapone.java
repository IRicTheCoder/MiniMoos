...
public class EntityYakCapone extends EntityMiniMoo
{
	public EntityYakCapone(World worldIn)
	{
		super(worldIn);
	}
	...
	private void affectPlayer(EntityPlayer player)
	{
		...
		{
			case 0:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.capone.hat", playerName)));
				player.addPotionEffect(new PotionEffect(MobEffects.BLINDNESS, 120, 0, true, true));
				break;
			case 1:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.capone.business", playerName)));
				player.addPotionEffect(new PotionEffect(MobEffects.HUNGER, 120, 0, true, true));
				break;
			case 2:
				player.addChatMessage(bossName.appendSibling(new TextComponentTranslation("talks.bossmoo.capone.protection", playerName)));
				player.addPotionEffect(new PotionEffect(MobEffects.INSTANT_DAMAGE, 2, 0, true, true));
				player.addPotionEffect(new PotionEffect(MobEffects.INSTANT_DAMAGE, 2, 0, true, true));
				player.addPotionEffect(new PotionEffect(MobEffects.INSTANT_DAMAGE, 2, 0, true, true));
				player.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 60, 0, true, true));
				break;
		}
	}
	...
	{
		return new ResourceLocation(References.MODID, "textures/entity/bosses/yakCapone.png");
	}
}
